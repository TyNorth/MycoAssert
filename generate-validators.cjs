...
function generateDtsContent(schemas) {
  let dtsContent = `// Auto-generated by AssertScript. Do not edit.\n`
...
function runGeneration() {
  ...
  console.log('\n--- Running AssertScript Generation ---')
  ...
  try {
    ...
    console.error('❌ AssertScript Error:', error.message)
...
if (require.main === module) {
  ...
  if (argv.watch) {
    ...
    const typesFilePath = path.join(__dirname, 'types.json')
    console.log(`👀 AssertScript is now watching ${typesFilePath} for changes...`)
